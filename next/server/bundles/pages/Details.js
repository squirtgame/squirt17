...
function (_Component) {
  ...
  _createClass(Details, [{
    ...
    value: function render() {
      ...
      }, "What do I do if I have a permit for an assigned lot, but can't find a space there?")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("dd", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        id: "faq1_desc",
        "class": "desc"
      }, "Park at the nearest available parking meter without paying the meter and call 999-999-9999 to report the problem. We will note and approve your alternate location and will investigate the cause of the shortage in your assigned facility.")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("dt", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        "aria-expanded": "false",
        "aria-controls": "faq2_desc"
      }, "What do I do if I lose my permit or if my permit is stolen?")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("dd", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        id: "faq2_desc",
        "class": "desc"
      }, "You should come to the Parking office and report the loss. There is a fee to replace your lost permit. However, if your permit was stolen, a copy of a police report needs to be submitted along with a stolen parking permit form for a fee replacement exemption.")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("dt", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        "aria-expanded": "false",
        "aria-controls": "faq3_desc"
      }, "Is there free parking on holidays?")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("dd", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        id: "faq3_desc",
        "class": "desc"
      }, "All facilities are restricted from 2:00 am - 6:00 am on all days. No exceptions are made for any holiday or recess except those officially listed as a", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("q", null, "Holidays"), "in the calendar. Please note: 24-hour rental spaces, 24-hour rental lots, and disabled parking is enforced at all times.")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("dt", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        "aria-expanded": "false",
        "aria-controls": "faq4_desc"
      }, "Do all parking facilities have the same enforcement rules?")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("dd", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        id: "faq4_desc",
        "class": "desc"
      }, "Some parking facility restrictions differ from others. Be sure to take note of the signs at each lot entrance."))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, "If nobody guesses correctly by the 17th guess, then the game ends and the HPB in the contract gets automatically transferred to the next game (minus a small dev fee) so as each game rolls over, the amount of Eth in the contract that is up for grabs gets bigger and bigger!"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h3", null, "FAQ"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b", null, "How is the number to guess generated?")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, "We harness the power of the HPB Hardware Random Number Generator (HRNG) to generate a random number for each game.  - Please see ", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a", {
